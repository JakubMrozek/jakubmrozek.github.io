...
exports.getGearContent = () => {
  const html = `
    ...
    <div class='flex'>
      ...
      Většinu věcí mám od začátku cesty (400+ dní). 
      Zde najdete jejich kompletní přehled s  popisky, na konci článku pak několik dalších poznámek, jak se výbava postupem času měnila.
      ...
      <a href='https://www.youtube.com/watch?v=6TxQHhM_vsM'>tohoto videa</a>. 
      Potřeboval jsem batoh, který by šel vzít do letadla, šlo s ním jít na více dní do hor, 
      ...
      Pod tričkem není vůbec vidět a mám jí proto, abych měl důležité doklady na dvou místech. 
      ...
      <p>Spacák jsem si koupil den před odjezdem a moc jsem neřešil značku. Potřeboval jsem co nejlehčí a do nejnižší teploty kolem 7 stupňů. Tenhle váží kolem 0,5 kg a spal jsem v něm tak 15 nocí. Využíval jsem ho hlavně v Mongolsku a Laosu při spaní v místech, kde jsem si nebyl úplně jistý čistotou.</p>
      <h3>Špunty do uší.</h3>
      ...
      <h3>Boty</h3>
      <p>Za první rok jsem udělal kolem 4,5 mil. kroků, takže jsou boty dost důležitým prvkem a doporučuji na nich nešetřit a dlouho si je vybírat. První mi vydržely 400 dní, druhé jsem si koupil v Tchaj-wanu. V Asii se boty kupují špatně, protože Asiati mají pidi nožičky a jejich velikosti končí o půl čísla níže než ty, které bych potřeboval.</p>
      ...
      <p>Mám jich 5x a každé trčko vydrží přibližně 4 - 6 měsíců s výjimkou jednoho kvalitního značkového Puma, které vydrželo celou dobu a vypadá stále stejně i po mnoha dnech nošení. Triček mám více, protože moje nejneoblibenější čínnost je praní. Dříve jsem měl 3, a to znamená, že jsem musel řešit každý druhý den večer praní, teď už je to každý 4. den.</p>
      ...
      <p>Apple je naprostý základ pro mojí práci. Používám ho kvůli vysoké vysoké spolehlivosti (vydrží 5+ let), baterii (mohu pracovat kdekoliv po mnoho hodin bez zásuvky), nízké váze (1,3 kg) a úžasnému ekosystému (propojení s iPhone), takže nejsem závislý na Wifi a častěji používám mobilní internet i pro práci.</p> 
      ...
      <p>Mnoho cestovatelů si pořizuje jeden univerzální adaptér, který lze pak použít v každé zásuvce, já si koupil dva malé, jeden pro telefon/power banku a jeden pro notebook. Poprvé jsem ho potřeboval až ve Filipínách, pak v Japonsku a na Tchaj-wanu, všude jinde mají podobné zásuvky jako v Česku. Dají se pořídit snadno skoro všude, na Filipínách stály kolem 15 Kč. Jinak se dají snadno půjčit v hotelech a různých ubytovných.</p>
      <h3>Power banka</h3>
      ...
      <li>Vějíř</li>
      <li>Čínskou učebnici od přítelkyně</li>
      <li>Zelený čaj</li>
      ...
      <p>(Vodní filtr Sawyer MINI, 58 g)</p>
      ...
      <p>
        Část výbavy jsem pořídil v obchodě <a href='http://shop.pod7kilo.cz/'>Pod 7 kilo</a>, 
        který se na vybavení s nízkou váhou specializuje. 
        Doporučuji ho navštívit ať už kvůli tipům na lehkou výbavu, tak také proto, že je postaven na systému, 
        který jsem před roky programoval :-)
      </p>
